...
Is it large document analysis (>100K tokens)?
  YES -> Gemini 3.1 Pro (cheapest very large context, 1M+ tokens)
...
Is it simple formatting / classification / extraction?
  YES -> Haiku 4.5, GPT-5.4 Mini, or local LLM (cheapest)
...
| Code generation | Low | Sonnet 4.6 / GPT-5.4 Mini | Local LLM | $0.10-0.30 |
...
| Formatting | Any | Local LLM / Haiku 4.5 | GPT-5.4 Mini | $0.01-0.05 |
| Large file analysis | Any | Gemini 3.1 Pro | Claude (1M+) | $0.10-0.50 |
| Multi-step automation | Any | OpenClaw agent | Claude Code | $0.20-1.00 |
| Image understanding | Any | Claude / GPT-5.4 | Gemini 3.1 Pro | $0.10-0.50 |
...
Level 2: Haiku 4.5 / GPT-5.4 Mini ($0.01-0.10)
  - Basic code generation
  - File exploration
  - Simple Q&A

Level 3: Sonnet 4.6 / Gemini 3.5 Flash ($0.10-0.50)
...
When an MCP routing server is configured, use its tools. These are the
conventional names; substitute your server's equivalents:
