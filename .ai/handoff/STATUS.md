...
> Note (2026-07-17, claude-fable-5): Reconciled the canonical consumer list (gate-sync CONSUMERS + hook-coverage registry) with the verified gated estate (22 consumers); documented the deliberate exclusions (AAHP spec source, secure-smart-factory owner-excluded).
